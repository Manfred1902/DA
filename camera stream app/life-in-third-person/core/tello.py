...
class TelloApp:
    ...
    def save_image(self) -> None:
        try:
            ...
            texture = MDApp.get_running_app().root.ids["home_screen"].ids["video_stream"].texture
    ...
    def record_video(self) -> None:
        try:
            if self.record:
                ...
                self.record = False
                self.video = None
                MDApp.get_running_app().root.ids["home_screen"].ids["record_video"].text = "Record Video"
            else:
                texture = MDApp.get_running_app().root.ids["home_screen"].ids["video_stream"].texture

                if texture:
                    self.record = True
                    MDApp.get_running_app().root.ids["home_screen"].ids["record_video"].text = "Stop Video Recording"
                    size = texture.size
